...
/**
 * The daily leaderboard on one screen: rows only. Today's rule capsule, the pot
 * header, and the prize ladder now live on the Arcade home — this board is the
 * live rankings (rows spectate on tap), the player's row highlight, and the
 * paid cut line. Entering a ranked run lives on the Arcade home.
 */
