...
import ArcadeDockIcon from "@/ui/navigation/ArcadeDockIcon";
import { DockCampaignIcon, DockProfileIcon } from "./dockIcons";
...
const TABS: {
  ...
  { id: "arcade", icon: ArcadeDockIcon, label: "Arcade" },
