  ...
  if (process.argv.includes("--help") || process.argv.includes("-h")) {
    process.stdout.write(
      [
        ...
        "  ZKUBE_DEPLOYER_PUBLIC_KEY=<funding fee payer address>",
        ...
        "  ZKUBE_LAUNCH_DEPLOYER_RESERVE_LAMPORTS=100000000",
        "",
        ...
        "has no sign or send path. The final deployment manifest is generated",
        "afterward and binds this plan fingerprint, avoiding a hash cycle.",
        "",
      ].join("\n"),
    );
    return;
