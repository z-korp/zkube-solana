//! Versioned accounts for the Solana/MagicBlock reboot.
//!
//! These are the only account types exported by the compiled program. Retired
//! prototype source files remain outside the module graph as reference material.
