...
use zkube_core::{
    ...
    PLAYER_LABEL_ACCOUNT_VERSION, PROTOCOL_ACCOUNT_VERSION, RULES_ACCOUNT_VERSION, SEASON_DAYS,
    SECONDS_PER_DAY, SOL_PAYOUT_UNIT_LAMPORTS, Sha256Provider, SoftwareSha256, WEEK_DAYS,
...
mod tests {
    ...
    fn committed_catalog_validates_and_hashes_stably() {
        ...
        assert!(versions.contains("ARENA_ENTRY_LAMPORTS = 20000000n"));
