...
use zkube_core_host::native::{self, Field, FieldType};
...
fn protocol(catalog: &CampaignCatalog) -> String {
    ...
    let mut output = String::from(
        "// Generated by zkube-codegen from zkube-core and campaign-catalog.json. Do not edit.\nnamespace ZKube.Core.Generated\n{\n    public static class Protocol\n    {\n",
    );
    for (name, value) in [
    ...
    .unwrap();
    output.push_str("        public static readonly byte[][] DailyThemes =\n        {\n");
