...
namespace ZKube.Tests.MoneyOverview
{
    public sealed partial class MoneyOverviewTests
    {
        [UnityTest] public IEnumerator CampaignRealmNavigationIsNotReadyUntilTheFinalRequestedArtworkCompletes()
        {
            ...
            while (!controller.PageReady && Time.realtimeSinceStartup < until) yield return null;
            Assert.That(controller.PageReady, Is.True);
            Click("Next realm"); Assert.That(controller.PageReady, Is.False, "The prior realm's ready flag cannot survive a new asynchronous request");
            Click("Next realm"); Assert.That(controller.PageReady, Is.False);
