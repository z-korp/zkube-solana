...
namespace ZKube.Local.Tests
{
    public sealed class BoardRealmBindingTests
    {
        ...
        public void LocalProvidersBindEveryRealmFromTheirRunView()
        {
            ...
            var client = new LocalRunClient(new LocalProductStore(_ => LocalProductCodec.Encode(state)), () => 20705L * 86400);
        ...
        {
            var client = new LocalRunClient(new LocalProductStore(), () => 20705L * 86400);
