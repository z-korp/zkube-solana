...
def main():
    ...
    parser.add_argument("action", choices=["open", "readiness", "load", "viewport", "input", "legal-input", "click", "profile", "profiler-export", "capture", "journey", "fault-journey", "settings", "sample-start", "sample-end", "mcp-settings", "exit"])
    parser.add_argument("--surface", choices=["board"], default="board")
    parser.add_argument("--fixture")
    parser.add_argument("--control")
    parser.add_argument("--scenario", choices=["native-rejection", "queued-discard", "uncertain-recovery"])
